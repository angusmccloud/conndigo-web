...
export default function GamesUpdateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setMinNumberOfTeams(cleanValues.minNumberOfTeams);
    setMaxNumberOfTeams(cleanValues.maxNumberOfTeams);
    setMinNumberOfPlayersPerTeam(cleanValues.minNumberOfPlayersPerTeam);
    setMaxNumberOfPlayersPerTeam(cleanValues.maxNumberOfPlayersPerTeam);
    setPoints(cleanValues.points ?? []);
    setCurrentPointsValue(undefined);
    setRules(cleanValues.rules);
    setCanHaveMultipleWinners(cleanValues.canHaveMultipleWinners);
    setErrors({});
  };
  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        type="number"
        step="any"
        defaultValue={minNumberOfPlayersPerTeam}
        onChange={(e) => {
          let value = parseInt(e.target.value);
          if (isNaN(value)) {
            setErrors((errors) => ({
      ...
      <TextField
        ...
        type="number"
        step="any"
        defaultValue={maxNumberOfPlayersPerTeam}
        onChange={(e) => {
          let value = parseInt(e.target.value);
          if (isNaN(value)) {
            setErrors((errors) => ({
