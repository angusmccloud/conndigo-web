...
export default function ScheduleUpdateForm(props) {
  ...
  const resetStateValues = () => {
    const cleanValues = { ...initialValues, ...scheduleRecord };
  ...
  const [scheduleRecord, setScheduleRecord] = React.useState(schedule);
  React.useEffect(() => {
    const queryData = async () => {
      const record = id ? await DataStore.query(Schedule, id) : schedule;
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(
            Schedule.copyOf(scheduleRecord, (updated) => {
